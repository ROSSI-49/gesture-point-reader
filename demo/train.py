...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    train_loader, dataset = create_dataloader(train_path, imgsz, batch_size // WORLD_SIZE, gs, single_cls,
                                              ...
                                              prefix=colorstr('train: '), data_dict=data_dict)
    ...
    if RANK in [-1, 0]:
        val_loader = create_dataloader(val_path, imgsz, batch_size // WORLD_SIZE * 2, gs, single_cls,
                                       ...
                                       prefix=colorstr('val: '), data_dict=data_dict)[0]
...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default='engine/pretrained/yolov5s_640.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default="yolov5s_640.yaml", help='model.yaml path')
    parser.add_argument('--data', type=str, default=data, help='dataset.yaml path')
    parser.add_argument('--hyp', type=str, default='data/hyps/hyp.scratch-v1.yaml', help='hyperparameters path')
    ...
    if opt.polyaxon:
        ...
        opt.project = os.path.join(rsync_data.get_polyaxon_output(), opt.project)
    return opt
